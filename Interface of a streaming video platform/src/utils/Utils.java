...
public final class Utils {
     ...
     */
    public static Map<ActorsAwards, Integer> convertAwards(
            final JSONArray jsonActors) {
        ...
        for (Object iterator : jsonActors) {
            awards.put(stringToAwards(
                    ...
                    Integer.parseInt(((JSONObject) iterator)
                            .get(Constants.NUMBER_OF_AWARDS)
                            .toString()));
        }
        ...
        if (movies != null) {
            for (Object movie : movies) {
                mapVideos.put((String) ((JSONObject) movie).get(Constants.NAME),
                        Integer.parseInt(
                                ((JSONObject) movie).get(Constants.NUMBER_VIEWS)
                                        .toString()));
            }
        } else {
